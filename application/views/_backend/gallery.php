                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    <!-- <a href="<?php echo site_url('admin/gallery') ?>" class="btn btn-success btn-flat" title="Refresh halaman">Refresh</a> -->
            ...
            <script type="text/javascript">
                var predefined_val = '<?php echo !empty($gallery) ? $gallery[0]->gallery_id : 0; ?>'; // your predefined value.
                $(document).ready(function() {
                    setInterval(function() {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "<?php echo "https://upbuhaluoleo.test-web.my.id/api/get_gallery_pegawai?nip=" . $this->session->userdata('user_nip'); ?>",
                            success: function(msg) {
                                var data = msg; // response data from your php script
                                // console.log(data[0].gallery_id);
                                if (predefined_val !== data[0].gallery_id) {
                                    // window.location.href = window.location.href;
                                    location.reload();
                                }
