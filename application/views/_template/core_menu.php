                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    if ($this->session->userdata('user_photo') == "") {
                                        ...
                                        echo '<img src="https://upbuhaluoleo.test-web.my.id/upload/user/' . $this->session->userdata('user_photo') . '" class="user-image" alt="User Image">';
                                    }
                                    ?>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        ...
                                        if ($this->session->userdata('user_photo') == "") {
                                            ...
                                            echo '<img src="https://upbuhaluoleo.test-web.my.id/upload/user/'  . $this->session->userdata('user_photo') . '" class="img-circle" alt="User Image">';
                                        }
                                        ?>
                                        <p>
                ...
                <section class="sidebar">
                    ...
                    <?php if ($this->session->userdata('user_group') == 1 or $this->session->userdata('user_group') == 2) { ?>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li><a href="<?php echo site_url('admin/pegawai') ?>"><i class="fa fa-users"></i> <span> Data Pegawai</span></a></li>
                            <!-- <li><a href="<?php echo site_url('admin/gallery') ?>"><i class="fa fa-file"></i> <span> Data File</span></a></li> -->
                        </ul>
                    <?php } else { ?>
                        <ul class="sidebar-menu" data-widget="tree">
                            <li class="header">MAIN NAVIGATION</li>
